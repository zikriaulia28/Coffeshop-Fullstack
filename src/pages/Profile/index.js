              ...
              <div className="w-full flex flex-col justify-between rounded-2xl border overflow-hidden bg-white">
                ...
                <div className="grid grid-cols-1 gap-2 ml-8 mr-14">
                  <div className="input flex flex-col">
                    ...
                    <input type="text" id="email" defaultValue={profileData.email} onChange={onChangeForm} name="email" className="py-2 border border-solid rounded-md pl-2" />
                  </div>
                  <div className="input flex flex-col">
                    <label htmlFor="phone" className="font-medium text-xl text-grey">Mobile number :</label>
                    <input type="text" id="phone" name="phone_number" defaultValue={profileData.phone_number} className="py-2 border border-solid rounded-md pl-2" />
                  </div>
                  <div className="input flex flex-col mb-2">
                    ...
                    <textarea name="address" id="address" rows="2" className='py-2 border border-solid rounded-md pl-2' defaultValue={profileData.address} onChange={handleInputChange}></textarea>
                  </div>
                </div>
                <hr className="w-full h-4 bg-secondary" />
              </div>
                ...
                <div className="flex flex-col ml-8 mr-14 gap-5 lg:flex-row">
                  <div className="flex flex-1 gap-5 flex-col">
                    <div className="input flex flex-col">
                      ...
                      <input type="text" id="displayName" name='display_name' defaultValue={profileData.display_name} className="py-2 border border-solid rounded-md pl-2" onChange={handleInputChange} />
                    </div>
                    <div className="input flex flex-col">
                      <label htmlFor="firstName" className="font-medium text-xl text-grey">First Name :</label>
                      <input type="text" id="firstName" name='firstname' defaultValue={profileData.firstname} className="py-2 border border-solid rounded-md pl-2" onChange={handleInputChange} />
                    </div>
                    <div className="input flex flex-col">
                      <label htmlFor="lastName" className="font-medium text-xl text-grey">Last Name :</label>
                      <input type="text" id="lastName" name='lastname' defaultValue={profileData.lastname} className="py-2 border border-solid rounded-md pl-2" onChange={handleInputChange} />
                    </div>
                  </div>
                  <div className="flex flex-1 gap-9 flex-col">
                    <div className="input flex flex-col">
                      <label htmlFor="birthDate" className="font-medium text-xl text-grey">DD/MM/YY</label>
                      <input type="date" id="birthDate" name='birth_day' defaultValue={formattedDate} className="py-2 border border-solid rounded-md pl-2" onChange={handleInputChange} />
                    </div>
                    <div className="flex gap-4">
                      <div className="input-data-radio flex gap-2">
                        <input type="radio" name="gender" id="male" value="male" className="hidden" readOnly />
                        <span></span>
                        <label htmlFor="male" className="font-medium text-xl text-grey cursor-pointer">Male</label>
                      </div>
                      <div className="input-data-radio flex gap-2">
                        <input type="radio" name="gender" id="female" value="female" className="hidden" readOnly />
                        <span></span>
